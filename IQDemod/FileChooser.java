 ...
 * 
 * Barb Ericson ericson@cc.gatech.edu is the original author. Class is slightly altered by Felix Zheng.
 * 
 * @author Felix Zheng
 */
  ...
  public static String getMediaDirectory() 
  {
    ...
    // try to find the images directory
      try {
        ...
        URL fileURL = new URL(classURL,"../IQDemod/"); //Modified from "images" to "IQDemod"
